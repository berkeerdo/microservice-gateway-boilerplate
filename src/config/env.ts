...
try {
  config = envSchema.parse({
    ...
    EXAMPLE_SERVICE_HTTP_URL: process.env.EXAMPLE_SERVICE_HTTP_URL,
    ...
    CIRCUIT_BREAKER_RESET_TIMEOUT_MS: parseInt(process.env.CIRCUIT_BREAKER_RESET_TIMEOUT_MS),
    CIRCUIT_BREAKER_HALF_OPEN_SUCCESS_THRESHOLD: parseInt(
      process.env.CIRCUIT_BREAKER_HALF_OPEN_SUCCESS_THRESHOLD
    ),
    CIRCUIT_BREAKER_FAILURE_WINDOW_MS: parseInt(process.env.CIRCUIT_BREAKER_FAILURE_WINDOW_MS),

    // HTTP Fallback
    HTTP_FALLBACK_ENABLED: parseBoolean(process.env.HTTP_FALLBACK_ENABLED, true),
    HTTP_FALLBACK_TIMEOUT_MS: parseInt(process.env.HTTP_FALLBACK_TIMEOUT_MS),
